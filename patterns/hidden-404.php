...
<h2 class="has-text-align-center" style="font-size:clamp(4rem, 40vw, 20rem);font-weight:100;line-height:1">
	<?php echo esc_html( _x( '404', 'Error code for a webpage that is not found.', 'test' ) ); ?>
</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">
	<?php esc_html_e( 'This page could not be found. Maybe try a search?', 'test' ); ?>
</p>
<!-- /wp:paragraph -->
...
<!-- wp:search {"label":"<?php esc_html_e( 'Search', 'test' ); ?>","showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php esc_html_e( 'Search', 'test' ); ?>","buttonUseIcon":true,"align":"center"} /-->
